                        ...
                        <div class="add-customer--left__content">
                            ...
                            <form id="house_infor" action="<?php echo e(route('admin.partnerTasks.update', ['id' => $task->id])); ?>" method="POST">
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="number" name="age" value="<?php echo e($task->age); ?>" required="required" patter="^[0-9]*$"/>
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="number" value="<?php echo e($task->update); ?>" name="update" required="required" patter="^[0-9]*$"/>
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="date" name="created_at" value="<?php echo e(getDateFromDateTime($task->created_at)); ?>" required="required" readonly/>
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="number" name="invest" value="<?php echo e($task->invest); ?>" required="required"/>
                                    </div>
                                    <div class="clear-fix"></div>
                                </div>
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        ...
                                        <select class="border--base padding--base" name="status" id="status">
                                            <option value="1" <?php echo e($task->status=="Done" ? "selected": ""); ?>>Done</option>
                                            <option value="0" <?php echo e($task->status=="Waiting" ? "selected" : ""); ?>>Waiting</option>
                                        </select>
                                    </div>
                                    <div class="clear-fix"></div>
                                </div>
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="number" name="contract" value="<?php echo e($task->contract); ?>" required="required"/>
