              ...
              <div class="banner-item__wrap">
                <div class="banner-item__wrap2">
                  ...
                  <div class="banner-item__wrap3">
                    ...
                    <p class="price"><?php echo e($house->unit); ?> <?php echo e($house->price); ?></p>
            ...
            <div class="row feature__wrap-slider">
              ...
              <?php endif; ?><i class="fas fa-heart"></i>
                    ...
                    <div class="feature__infor">
                      ...
                      <p class="feature__infor--des"><?php echo $house->description; ?></p>
                      <p class="sale">For  Sale</p>
                      <p class="price"><?php echo e($house->unit); ?> <?php echo e($house->price); ?></p><a class="btn-view link-base" href="<?php echo e(route('get.detail',['id'=>$house->id])); ?>"><span>View Property &gt;</span></a>
                    </div>
                  </div>
                </div>        
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-5 col-sm-6 col-xl-5">
                      <div class="item__detail">
                        ...
                        <div class="item__detail--infor">
                          ...
                          <p class="price"><?php echo e($house->unit); ?> <?php echo e($house->price); ?></p><a class="btn btn-primary btn-play btn-base" href=""><span>play</span></a>
                        </div>
                      </div>
                    </div>
