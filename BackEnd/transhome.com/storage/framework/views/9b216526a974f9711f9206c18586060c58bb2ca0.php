...
<div class="header__wrap">
  ...
  <div class="header__main">
    ...
    <div class="container">
      <div class="row">
        <div class="col-3">
          <div class="logo"><a href="<?php echo e(route('get.index')); ?>">
            <?php if($setup->logo_header == ""): ?>
            <img src="https://via.placeholder.com/150" alt="logo"/>
            <?php else: ?>
            <img src="<?php echo e(asset($setup->logo_header)); ?>" alt="logo"/>
            <?php endif; ?>
          </a></div>
        </div>
        <div class="col-9">
          <div class="main__menu">
            <nav>
              <ul class="list-inline">
                ...
                <li><a href="<?php echo e(route('get.freecash')); ?>"><span>Sell My House</span></a></li>
