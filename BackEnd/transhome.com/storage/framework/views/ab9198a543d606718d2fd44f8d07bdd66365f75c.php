    ...
    <div class="danhsachtk content-wrap content-wrap2" id="danhsachtk">
        <div class="tk-top tk-top-wrap">
            <div class="tk-top__top">
                <div class="tk-top__top--left fleft col-50">
                    ...
                    <a class="add-new" href="<?php echo e(route('admin.customers.create')); ?>">Add new</a>
                </div>
        ...
        <div class="danhsachtk__table table--base customer-table">
            ...
            <div class="fright total">
                <p>Total : 
                    <span><?php echo e($view); ?> entries</span>
                </p>
            </div>
            <table>
                <tr>
                ...
                <?php if(isset($customers)): ?>
                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <p class="name line"><?php echo e($customer->first_name); ?></p>
                            </td>
                            <td>
                                <p class="name line"><?php echo e($customer->last_name); ?></p>
                            </td>
                            <td>
                                <p class="line">
                            ...
                            <td>
                                <p class="line3"><?php echo e($customer->address); ?></p>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="table-icon"><a href="<?php echo e(route('admin.customers.show', ['id' => $customer->id])); ?>"><i
                                                class="far fa-eye" title="Detail"></i></a>
                                    <a class="recycle" data-url="<?php echo e(route('admin.customers.destroy', ['id' => $customer->id])); ?>"
