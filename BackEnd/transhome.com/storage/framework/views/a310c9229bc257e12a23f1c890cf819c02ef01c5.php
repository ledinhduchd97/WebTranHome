                                    ...
                                    <div class="edit-house--left__item">
                                        ...
                                        <div class="content">
                                            ...
                                            <select class="border--base padding--base" id="unit" name="unit">
                                                    <option value="0" <?php echo e($house->get_value_unit($house->unit) == 0?"selected":""); ?>>€</option>
                                                    <option value="1" <?php echo e($house->get_value_unit($house->unit) == 1?"selected":""); ?>>$</option>
                                                    <option value="2" <?php echo e($house->get_value_unit($house->unit) == 2?"selected":""); ?>>£</option>
                                            </select>
                                        ...
                                        <div class="edit-house--left__item">
                                            ...
                                            <div class="content">
                                                <select class="border--base padding--base" id="status" name="status">
                                                        <option value="0" <?php echo e($house->status===0 ? "selected" : ""); ?>>New</option>
                                                        <option value="1" <?php echo e($house->status===1 ? "selected" : ""); ?>>Bought</option>
                                                </select>
