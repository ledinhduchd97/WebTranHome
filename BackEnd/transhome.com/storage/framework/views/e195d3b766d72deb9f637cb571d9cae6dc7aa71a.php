              ...
              <div class="col-4 col-md-3 text-center">
                <div class="information__house--price">
                  <h4><?php if($house->unit == 0 ): ?>
                                                ...
                                                <?php if($house->unit == 2): ?>
                                                    £  
                                                <?php endif; ?> <?php echo e($house->price); ?></h4>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-9">
                ...
                <div class="property_desc">
                  ...
                  <p class="property_desc--content"><?php echo e($house->description); ?></p>
                </div>
                          ...
                          <div class="other_house--content text-center">
                            <a class="other_house--item__content2" href="<?php echo e(route('get.detail',['id'=>$hl->id])); ?>">
                              ...
                              <div class="other_house--item__desc text-left">
                                ...
                                <p class="price highlight2"><?php if($hl->unit == 0 ): ?>
                                                    €
                                                <?php endif; ?> 
                                                <?php if($hl->unit == 1): ?>
                                                    $
                                                ...
                                                <?php if($hl->unit == 2): ?>
                                                    £  
                                                <?php endif; ?> <?php echo e($hl->price); ?></p>
                              </div>
                            </a>
                          </div>
