        ...
        <div class="tk-top tk-top-wrap">
            <div class="tk-top__top">
                <div class="tk-top__top--left fleft col-50">
                    ...
                    <a class="add-new" href="<?php echo e(route('admin.tasks.create')); ?>">Add task</a>
                </div>
                ...
                <?php if(isset($tasks)): ?>
                    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <div class="table-icon"><a href="<?php echo e(route('admin.tasks.show', ['id' => $task->id])); ?>"><i
                                                class="far fa-eye" title="Detail"></i></a>
                                    <a class="recycle" data-url="<?php echo e(route('admin.tasks.destroy', ['id' => $task->id])); ?>"
