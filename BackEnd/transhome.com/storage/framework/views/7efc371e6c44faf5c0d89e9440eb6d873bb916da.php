                        ...
                        <div class="add-customer--left__content">
                            ...
                            <form id="house_infor" action="<?php echo e(route('admin.partner.update', ['partner' => $partner->id])); ?>" method="POST">
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="text" name="fullname" value="<?php echo e($partner->fullname); ?>" required="required" maxlength="64" readonly/>
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="text" name="email" value="<?php echo e($partner->email); ?>" required="required" maxlength="64" readonly/>
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="phone" name="phone"  value="<?php echo e($partner->phone); ?>" required="required" readonly/>
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="text" name="address" value="<?php echo e($partner->address); ?>" required="required" maxlength="250"/>
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="text" name="partner_type" value="<?php echo e($partner->partner_type); ?>" required="required" maxlength="250"/>
                                ...
                                <div class="add-customer--left__item">
                                    ...
                                    <div class="content">
                                        <input class="border--base padding--base" type="text" name="status" value="<?php echo e($partner->status); ?>" required="required" maxlength="250"/>
