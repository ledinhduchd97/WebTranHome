            ...
            <div class="view-detail__content">
                ...
                <form action="">
                    ...
                    <div class="view-detail__content--row">
                        ...
                        <div class="content"><span class="acc-address"><?php echo e($task->invest); ?></span></div>
                        <div class="clear-fix"></div>
                    </div>
                    <div class="view-detail__content--row">
                        <div class="text"><span>Contract :</span></div>
                        <div class="content"><span class="acc-address"><?php echo e($task->contract); ?></span></div>
                        <div class="clear-fix"></div>
                    </div>
                    <div class="view-detail__content--row">
                    ...
                    <div class="view-detail__content--row text-center">
                        <a class="btn-edit btn--primary padding--base"
                           href="<?php echo e(route('admin.partnerTasks.edit',['id'=>$task->id])); ?>">Edit</a>
